...
- **RPGM工具：**可按游戏选择文字速度、对话框透明度、自动翻页、随时保存、高速移动、穿墙、随机遇敌和一键战胜/战败。
...
1. **下载 RenpyLens**
   - 从仓库右侧的 **Releases** 页面下载最新版 `RenpyLens_v1.5.3.exe`。
   - 也可以按照下方开发说明从源码运行。
2. **选择翻译服务**
...
4. **安装 Hook 并启动**
   ...
   - 启用“随时保存”后，可在地图事件或对话中点击游戏右上角的“保存”，也可按 `Ctrl+S` 调出原生保存界面。在对话或选项期间保存时，读档会从当前对话开始，选项恢复为未选择状态。
5. **使用浮窗**
   - 拖动浮窗可调整位置。
