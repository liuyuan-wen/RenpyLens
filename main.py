...
from PyQt5.QtGui import QFont, QDragEnterEvent, QDropEvent, QIcon, QColor, QPalette, QTextCursor
...
HOOK_SCRIPT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_translator_hook.rpy")
